// https://www.reddit.com/r/adventofcode/comments/rds32p/2021_day_11_solutions/ho3bm39/?utm_source=reddit&utm_medium=web2x&context=3
// https://github.com/N8Brooks/deno_aoc/blob/main/year_2021/day_11.ts
...
function part2(octopuses: number[][]) {}
...
//  */
// function challenge1() {
//   let input = parseInput(`${__dirname}/input`, '\n');
//   // Run the input through the step incrementer 100 times
//   let numFlashes = 0;
//   for (let i = 0; i < 100; i++) {
//     const output = incrementStep(input);
...
//   const input = fs.readFileSync(fileName, 'utf-8').split(splitChar);
